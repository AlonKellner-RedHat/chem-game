...
import { PURE_WATER_ABSORPTION } from '../../core/materials/AbsorptionData';
// These imports will fail initially (RED phase) - implementations come later
import { BaseMaterialAbsorption, MoleculeAbsorption } from '../../core/materials/AbsorptionModel';
  ...
  describe('AbsorptionModel interface', () => {
    ...
    it('MoleculeAbsorption returns extinction from peaks', () => {
      const molecule = {
        ...
        peaks: [{ wavelength: 500, extinction: 10, naturalWidth: 20 }],
      };
