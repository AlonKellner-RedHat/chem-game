...
describe('SpectralPhysicsEngine', () => {
  ...
  describe('computeRGB', () => {
    ...
    it('accepts transmission function', () => {
      const result = engine.computeRGB((wavelength) => (wavelength < 500 ? 0.1 : 0.9), 300);
      expect(result).toHaveLength(3);
    });
  ...
  describe('computeSpectrum', () => {
    ...
    it('accepts transmission function', () => {
      const result = engine.computeSpectrum((wavelength) => (wavelength < 500 ? 0.1 : 0.9), 300);
