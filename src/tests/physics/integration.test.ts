...
import { voigtProfile, gaussianProfile, lorentzianProfile } from '../../core/physics/voigt';
  ...
  describe('integrateVoigtOverBin', () => {
    ...
    it('should satisfy energy conservation for Voigt profile', () => {
      ...
      for (let binStart = -5000; binStart < 6000; binStart += binWidth) {
        totalIntegral += integrateVoigtOverBin(center, binStart, binStart + binWidth, gaussianFWHM, lorentzianFWHM);
      }
    ...
    it('should capture narrow emission line in wide rendering bin', () => {
      ...
      const integral = integrateVoigtOverBin(center, binStart, binEnd, gaussianFWHM, lorentzianFWHM);
    ...
    it('should match numerical integration of voigtProfile', () => {
      ...
      const analyticalIntegral = integrateVoigtOverBin(center, binStart, binEnd, gaussianFWHM, lorentzianFWHM);
  ...
  describe('Energy Conservation Across Resolutions', () => {
    it('should preserve total energy when changing bin resolution', () => {
      ...
      for (let i = 0; i < highResBins; i++) {
        ...
        highResTotal += integrateVoigtOverBin(center, binStart, binStart + highResStep, gaussianFWHM, lorentzianFWHM);
      }
      ...
      for (let i = 0; i < lowResBins; i++) {
        ...
        lowResTotal += integrateVoigtOverBin(center, binStart, binStart + lowResStep, gaussianFWHM, lorentzianFWHM);
      }
