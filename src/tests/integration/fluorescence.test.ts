...
import { ChromiumIon, createCrystalMaterial } from '../../core/materials/CrystalMaterial';
import {
  createGasMaterial,
  MercuryAtom,
  NeonAtom,
  SodiumAtom,
} from '../../core/materials/GasMaterial';
...
describe('Fluorescence Integration', () => {
  ...
  describe('Material Texture Generation', () => {
    it('all materials can generate fluorescence textures', () => {
      const materials = [createGasMaterial(), createWaterMaterial(), createCrystalMaterial()];
