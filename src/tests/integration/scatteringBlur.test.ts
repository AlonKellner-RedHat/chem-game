...
describe('Scattering Blur Physics', () => {
  ...
  describe('Combined Rayleigh and Mie blur', () => {
    it('combined blur should be dominated by larger component', () => {
      ...
      const rayleighBlue = getRayleighScattering(450, { particleDensity: density, particleSize: 50 });
      const rayleighRed = getRayleighScattering(650, { particleDensity: density, particleSize: 50 });
