 ...
 */
export function voigtProfile(x: number, gaussianFWHM: number, lorentzianFWHM: number): number {
  // Handle edge cases
 ...
 */
export function voigtFWHM(gaussianFWHM: number, lorentzianFWHM: number): number {
