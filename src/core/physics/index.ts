...
export { generateBackgroundSpectrum, getBackgroundIntensity } from './backgrounds';
export {
  evToWavelength,
  getBandGapTransmission,
  getTaucAbsorption,
  wavelengthToEV,
} from './bandgap';
export { generateCIETextures, getCIE_X, getCIE_XYZ, getCIE_Y, getCIE_Z } from './cie';
// Re-export config types and utilities
export * from './config';
// Re-export constants
export * from './constants';
export { fastIntegrateToXYZ, generateD65Spectrum, integrateToXYZ } from './integration';
export { computeSpectrumValue, getEmissionOnly, getKirchhoffEmission } from './kirchhoff';
...
export { gammaCorrect, normalizeXYZ, xyzTo8BitSRGB, xyzToLinearRGB, xyzToSRGB } from './srgb';
export {
  gaussianProfile,
  getTotalLinewidth,
  lorentzianProfile,
...
export function createPhysicsEngine(
  ...
  return {
    ...
    computeRGB(
      ...
      const getTrans = typeof transmission === 'function' ? transmission : () => transmission;
    ...
    computeSpectrum(
      ...
      const step =
        plot.wavelengthStep || (shared.wavelengthMax - shared.wavelengthMin) / (resolution - 1);
