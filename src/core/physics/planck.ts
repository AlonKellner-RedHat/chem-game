...
import { C1, C2, D65_TEMPERATURE, DRAPER_POINT } from './constants';
 ...
 */
export function getRawPlanckRadiance(wavelengthNm: number, temperatureK: number): number {
 ...
 */
export function getPlanckRadiance(wavelengthNm: number, temperatureK: number): number {
