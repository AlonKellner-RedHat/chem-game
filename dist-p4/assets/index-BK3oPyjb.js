...
`,M=class M{constructor(e){r(this,"device");r(this,"colorPipeline",null);r(this,"spectrumBoxPipeline",null);r(this,"averagePipeline",null);r(this,"bindGroupLayout0",null);r(this,"bindGroupLayout1",null);r(this,"bindGroupLayout2",null);r(this,"bindGroupLayout3",null);r(this,"pipelineLayout",null);r(this,"paramsBuffer",null);r(this,"shapesBuffer",null);r(this,"rgbOutputBuffer",null);r(this,"spectrumOutputBuffer",null);r(this,"maxPerPixelBuffer",null);r(this,"spectrumBoxBuffer",null);r(this,"lastGlobalMaxIntensity",1);r(this,"materialPaletteTexture",null);r(this,"numMaterials",0);r(this,"msdfTextures",[]);r(this,"cieTextures",null);r(this,"cieScalesBuffer",null);r(this,"textureSampler",null);r(this,"msdfSampler",null);r(this,"bindGroup0",null);r(this,"bindGroup1",null);r(this,"bindGroup2",null);r(this,"bindGroup3",null);r(this,"width",0);r(this,"height",0);r(this,"plotResolution",M.MAX_SPECTRAL_RESOLUTION);r(this,"boxSize",M.DEFAULT_BOX_SIZE);r(this,"timestampQuerySet",null);r(this,"timestampBuffer",null);r(this,"timestampReadBuffer",null);r(this,"hasTimestampSupport",!1);r(this,"lastPassTimings",[]);this.device=e,this.hasTimestampSupport=e.features.has("timestamp-query")}async initialize(){const e=this.device.createShaderModule({label:"Spectral Compute Shader",code:ie});this.createBindGroupLayouts(),this.pipelineLayout=this.device.createPipelineLayout({label:"Spectral Pipeline Layout",bindGroupLayouts:[this.bindGroupLayout0,this.bindGroupLayout1,this.bindGroupLayout2,this.bindGroupLayout3]}),this.colorPipeline=this.device.createComputePipeline({label:"Color Compute Pipeline",layout:this.pipelineLayout,compute:{module:e,entryPoint:"main"}}),this.spectrumBoxPipeline=this.device.createComputePipeline({label:"Spectrum Box Pipeline",layout:this.pipelineLayout,compute:{module:e,entryPoint:"computeSpectrumBox"}}),this.averagePipeline=this.device.createComputePipeline({label:"Spectrum Average Pipeline",layout:this.pipelineLayout,compute:{module:e,entryPoint:"averageSpectrum"}});const t=this.device.features.has("float32-filterable");this.textureSampler=this.device.createSampler({addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",magFilter:t?"linear":"nearest",minFilter:t?"linear":"nearest"}),this.msdfSampler=this.device.createSampler({addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",magFilter:"linear",minFilter:"linear"}),this.hasTimestampSupport&&this.initTimestampQueries(),this.initCIETextures(),this.initDefaultMaterialPalette(),this.initDefaultMSDFTextures(),this.initSpectrumBoxBuffer(),console.log("[SpectralCompute] Pipeline initialized"),console.log(`[SpectralCompute] Timestamp queries: ${this.hasTimestampSupport?"enabled":"disabled"}`),console.log(`[SpectralCompute] f16 support: ${this.device.features.has("shader-f16")?"enabled":"disabled"}`)}initTimestampQueries(){this.timestampQuerySet=this.device.createQuerySet({type:"timestamp",count:8}),this.timestampBuffer=this.device.createBuffer({size:8*8,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC}),this.timestampReadBuffer=this.device.createBuffer({size:8*8,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST})}createBindGroupLayouts(){const e=this.device.features.has("float32-filterable"),t=e?"float":"unfilterable-float",i=e?"filtering":"non-filtering";this.bindGroupLayout0=this.device.createBindGroupLayout({label:"Bind Group Layout 0 (Buffers)",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:4,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:5,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),this.bindGroupLayout1=this.device.createBindGroupLayout({label:"Bind Group Layout 1 (Material Palette)",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:t}},{binding:1,visibility:GPUShaderStage.COMPUTE,sampler:{type:i}}]}),this.bindGroupLayout2=this.device.createBindGroupLayout({label:"Bind Group Layout 2 (CIE)",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:t}},{binding:1,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:t}},{binding:2,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:t}},{binding:3,visibility:GPUShaderStage.COMPUTE,sampler:{type:i}},{binding:4,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),this.bindGroupLayout3=this.device.createBindGroupLayout({label:"Bind Group Layout 3 (MSDF)",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"float"}},{binding:4,visibility:GPUShaderStage.COMPUTE,sampler:{type:"filtering"}}]})}initDefaultMaterialPalette(){const e=new Float32Array(100).fill(1);this.createMaterialPalette([e])}initCIETextures(){const t=te(380,700,321);this.cieTextures={x:z(this.device,t.x,"CIE X"),y:z(this.device,t.y,"CIE Y"),z:z(this.device,t.z,"CIE Z")},this.cieScalesBuffer=W(this.device,16),this.device.queue.writeBuffer(this.cieScalesBuffer,0,new Float32Array([t.scales.x,t.scales.y,t.scales.z,0]))}initDefaultMSDFTextures(){for(let e=0;e<4;e++){const t=this.device.createTexture({label:`Default MSDF ${e}`,size:{width:1,height:1,depthOrArrayLayers:1},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});this.device.queue.writeTexture({texture:t},new Uint8Array([0,0,0,255]),{bytesPerRow:4,rowsPerImage:1},{width:1,height:1,depthOrArrayLayers:1}),this.msdfTextures.push(t)}}initSpectrumBoxBuffer(){const e=this.boxSize*this.boxSize*this.plotResolution*4;this.spectrumBoxBuffer=this.device.createBuffer({label:"Spectrum Box",size:e,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC}),console.log(`[SpectralCompute] Spectrum box buffer: ${(e/1024/1024).toFixed(2)} MB`)}setMaskTextures(e){for(this.msdfTextures=e;this.msdfTextures.length<4;){const t=this.device.createTexture({label:`Padding MSDF ${this.msdfTextures.length}`,size:{width:1,height:1,depthOrArrayLayers:1},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});this.device.queue.writeTexture({texture:t},new Uint8Array([0,0,0,255]),{bytesPerRow:4,rowsPerImage:1},{width:1,height:1,depthOrArrayLayers:1}),this.msdfTextures.push(t)}this.bindGroup3=null}setMaterials(e){if(e.length===0){const t=new Float32Array(100).fill(1);this.createMaterialPalette([t])}else this.createMaterialPalette(e);this.bindGroup1=null}createMaterialPalette(e){if(e.length===0)return;const t=e[0].length,i=e.length,n=new Float32Array(t*i);for(let s=0;s<i;s++){const a=e[s],o=s*t;for(let h=0;h<t;h++)n[o+h]=a[h]??1}this.materialPaletteTexture=this.device.createTexture({label:`Material Palette (${i} materials)`,size:{width:t,height:i,depthOrArrayLayers:1},format:"r32float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),this.device.queue.writeTexture({texture:this.materialPaletteTexture},n,{bytesPerRow:t*4,rowsPerImage:i},{width:t,height:i,depthOrArrayLayers:1}),this.numMaterials=i}resize(e,t){var n,s,a;if(e===this.width&&t===this.height)return;this.width=e,this.height=t,(n=this.rgbOutputBuffer)==null||n.destroy(),(s=this.spectrumOutputBuffer)==null||s.destroy(),(a=this.maxPerPixelBuffer)==null||a.destroy();const i=e*t;this.rgbOutputBuffer=this.device.createBuffer({label:"RGB Output",size:i*4*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC}),this.spectrumOutputBuffer=this.device.createBuffer({label:"Spectrum Output",size:M.MAX_SPECTRAL_RESOLUTION*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC}),this.maxPerPixelBuffer=this.device.createBuffer({label:"Max Per Pixel",size:i*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC}),this.bindGroup0=null}async compute(e,t){var P;if(!this.colorPipeline)throw new Error("Pipeline not initialized");this.plotResolution=e.plotResolution??M.MAX_SPECTRAL_RESOLUTION;const i=e.boxSize??M.DEFAULT_BOX_SIZE;i!==this.boxSize&&(this.boxSize=i,(P=this.spectrumBoxBuffer)==null||P.destroy(),this.initSpectrumBoxBuffer(),this.bindGroup0=null),this.resize(e.width,e.height),this.updateShapesBuffer(t);const n=(e.sampleX??-1)>=0&&(e.sampleY??-1)>=0,s=Math.ceil(e.width/8),a=Math.ceil(e.height/8);this.lastPassTimings=[];const o=performance.now();this.updateParamsBuffer(e,0,1),this.ensureBindGroups();const h=this.device.createCommandEncoder(),u=h.beginComputePass();u.setPipeline(this.colorPipeline),u.setBindGroup(0,this.bindGroup0),u.setBindGroup(1,this.bindGroup1),u.setBindGroup(2,this.bindGroup2),u.setBindGroup(3,this.bindGroup3),u.dispatchWorkgroups(s,a),u.end(),this.device.queue.submit([h.finish()]);const c=await this.readMaxPerPixel();let d=.001;for(let x=0;x<c.length;x++)c[x]>d&&(d=c[x]);this.lastGlobalMaxIntensity=d;const p=performance.now();this.lastPassTimings.push({name:"Pass 0 (Color)",startTime:o,endTime:p,duration:p-o});const m=performance.now();this.updateParamsBuffer(e,1,d);const g=this.device.createCommandEncoder(),f=g.beginComputePass();f.setPipeline(this.colorPipeline),f.setBindGroup(0,this.bindGroup0),f.setBindGroup(1,this.bindGroup1),f.setBindGroup(2,this.bindGroup2),f.setBindGroup(3,this.bindGroup3),f.dispatchWorkgroups(s,a),f.end(),this.device.queue.submit([g.finish()]),await this.device.queue.onSubmittedWorkDone();const w=performance.now();if(this.lastPassTimings.push({name:"Pass 1 (Normalize)",startTime:m,endTime:w,duration:w-m}),n&&this.spectrumBoxPipeline&&this.averagePipeline){const x=performance.now();this.updateParamsBuffer(e,0,d),this.ensureBindGroups();const G=Math.ceil(this.boxSize/8),y=Math.ceil(this.boxSize/8),v=this.device.createCommandEncoder(),b=v.beginComputePass();b.setPipeline(this.spectrumBoxPipeline),b.setBindGroup(0,this.bindGroup0),b.setBindGroup(1,this.bindGroup1),b.setBindGroup(2,this.bindGroup2),b.setBindGroup(3,this.bindGroup3),b.dispatchWorkgroups(G,y),b.end(),this.device.queue.submit([v.finish()]),await this.device.queue.onSubmittedWorkDone();const k=performance.now();this.lastPassTimings.push({name:"Pass 2 (Spectrum Box)",startTime:x,endTime:k,duration:k-x});const B=performance.now();this.ensureBindGroups();const H=Math.ceil(this.plotResolution/256),$=this.device.createCommandEncoder(),T=$.beginComputePass();T.setPipeline(this.averagePipeline),T.setBindGroup(0,this.bindGroup0),T.setBindGroup(1,this.bindGroup1),T.setBindGroup(2,this.bindGroup2),T.setBindGroup(3,this.bindGroup3),T.dispatchWorkgroups(H),T.end(),this.device.queue.submit([$.finish()]),await this.device.queue.onSubmittedWorkDone();const A=performance.now();this.lastPassTimings.push({name:"Pass 3 (Average)",startTime:B,endTime:A,duration:A-B})}return{globalMaxIntensity:d}}getLastGlobalMaxIntensity(){return this.lastGlobalMaxIntensity}getPassTimings(){return this.lastPassTimings}async readRGBOutput(){if(!this.rgbOutputBuffer)throw new Error("No output buffer");return I(this.device,this.rgbOutputBuffer,this.width*this.height*4*4)}async readSpectrumOutput(){if(!this.spectrumOutputBuffer)throw new Error("No spectrum buffer");return I(this.device,this.spectrumOutputBuffer,this.plotResolution*4)}async readMaxPerPixel(){if(!this.maxPerPixelBuffer)throw new Error("No max buffer");return I(this.device,this.maxPerPixelBuffer,this.width*this.height*4)}getRGBBuffer(){return this.rgbOutputBuffer}updateParamsBuffer(e,t=0,i=1){this.paramsBuffer||(this.paramsBuffer=W(this.device,64));const n=e.backgroundMode==="normal"?0:e.backgroundMode==="uv"?1:2,s=new ArrayBuffer(64),a=new DataView(s);a.setUint32(0,e.width,!0),a.setUint32(4,e.height,!0),a.setFloat32(8,e.wavelengthMin,!0),a.setFloat32(12,e.wavelengthMax,!0),a.setUint32(16,e.spectralResolution,!0),a.setUint32(20,n,!0),a.setUint32(24,e.enableEmission?1:0,!0),a.setInt32(28,e.sampleX??-1,!0),a.setInt32(32,e.sampleY??-1,!0),a.setUint32(36,t,!0),a.setFloat32(40,i,!0),a.setFloat32(44,e.msdfPxRange??4,!0),a.setUint32(48,this.numMaterials,!0),a.setUint32(52,e.plotResolution??5e3,!0),a.setUint32(56,e.averageRadius??5,!0),a.setUint32(60,this.boxSize,!0),this.device.queue.writeBuffer(this.paramsBuffer,0,s)}updateShapesBuffer(e){var s;const i=new ArrayBuffer(Math.max(e.length,1)*48),n=new DataView(i);for(let a=0;a<e.length;a++){const o=a*48,h=e[a];n.setFloat32(o+0,h.x,!0),n.setFloat32(o+4,h.y,!0),n.setFloat32(o+8,h.width,!0),n.setFloat32(o+12,h.height,!0),n.setFloat32(o+16,h.temperature,!0),n.setUint32(o+20,h.layer,!0),n.setUint32(o+24,h.materialIndex,!0),n.setUint32(o+28,h.maskIndex,!0),n.setFloat32(o+32,h.texWidth??256,!0),n.setFloat32(o+36,h.texHeight??256,!0)}(!this.shapesBuffer||this.shapesBuffer.size<i.byteLength)&&((s=this.shapesBuffer)==null||s.destroy(),this.shapesBuffer=this.device.createBuffer({label:"Shapes",size:i.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.bindGroup0=null),this.device.queue.writeBuffer(this.shapesBuffer,0,i)}ensureBindGroups(){if(!this.bindGroup0){if(!this.paramsBuffer||!this.shapesBuffer||!this.rgbOutputBuffer||!this.spectrumOutputBuffer||!this.maxPerPixelBuffer||!this.spectrumBoxBuffer||!this.bindGroupLayout0){console.error("[SpectralCompute] Cannot create bindGroup0 - missing buffers or layout");return}this.bindGroup0=this.device.createBindGroup({label:"Bind Group 0 (Buffers)",layout:this.bindGroupLayout0,entries:[{binding:0,resource:{buffer:this.paramsBuffer}},{binding:1,resource:{buffer:this.shapesBuffer}},{binding:2,resource:{buffer:this.rgbOutputBuffer}},{binding:3,resource:{buffer:this.spectrumOutputBuffer}},{binding:4,resource:{buffer:this.maxPerPixelBuffer}},{binding:5,resource:{buffer:this.spectrumBoxBuffer}}]})}if(!this.bindGroup1){if(this.materialPaletteTexture||this.initDefaultMaterialPalette(),!this.textureSampler||!this.materialPaletteTexture||!this.bindGroupLayout1){console.error("[SpectralCompute] Cannot create bindGroup1 - missing resources or layout");return}this.bindGroup1=this.device.createBindGroup({label:"Bind Group 1 (Material Palette)",layout:this.bindGroupLayout1,entries:[{binding:0,resource:this.materialPaletteTexture.createView()},{binding:1,resource:this.textureSampler}]})}if(!this.bindGroup2){if(!this.cieTextures||!this.cieScalesBuffer||!this.textureSampler||!this.bindGroupLayout2){console.error("[SpectralCompute] Cannot create bindGroup2 - missing CIE resources or layout");return}this.bindGroup2=this.device.createBindGroup({label:"Bind Group 2 (CIE)",layout:this.bindGroupLayout2,entries:[{binding:0,resource:this.cieTextures.x.createView()},{binding:1,resource:this.cieTextures.y.createView()},{binding:2,resource:this.cieTextures.z.createView()},{binding:3,resource:this.textureSampler},{binding:4,resource:{buffer:this.cieScalesBuffer}}]})}if(!this.bindGroup3){for(;this.msdfTextures.length<4;){const e=this.device.createTexture({label:`Fallback MSDF ${this.msdfTextures.length}`,size:{width:1,height:1,depthOrArrayLayers:1},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});this.device.queue.writeTexture({texture:e},new Uint8Array([0,0,0,255]),{bytesPerRow:4,rowsPerImage:1},{width:1,height:1,depthOrArrayLayers:1}),this.msdfTextures.push(e)}if(!this.msdfSampler||!this.bindGroupLayout3){console.error("[SpectralCompute] Cannot create bindGroup3 - missing MSDF sampler or layout");return}this.bindGroup3=this.device.createBindGroup({label:"Bind Group 3 (MSDF)",layout:this.bindGroupLayout3,entries:[{binding:0,resource:this.msdfTextures[0].createView()},{binding:1,resource:this.msdfTextures[1].createView()},{binding:2,resource:this.msdfTextures[2].createView()},{binding:3,resource:this.msdfTextures[3].createView()},{binding:4,resource:this.msdfSampler}]})}}getNumMaterials(){return this.numMaterials}destroy(){var e,t,i,n,s,a,o,h,u,c,d,p,m,g;(e=this.paramsBuffer)==null||e.destroy(),(t=this.shapesBuffer)==null||t.destroy(),(i=this.rgbOutputBuffer)==null||i.destroy(),(n=this.spectrumOutputBuffer)==null||n.destroy(),(s=this.maxPerPixelBuffer)==null||s.destroy(),(a=this.spectrumBoxBuffer)==null||a.destroy(),(o=this.cieScalesBuffer)==null||o.destroy(),(h=this.timestampBuffer)==null||h.destroy(),(u=this.timestampReadBuffer)==null||u.destroy(),(c=this.timestampQuerySet)==null||c.destroy(),(d=this.materialPaletteTexture)==null||d.destroy();for(const f of this.msdfTextures)f.destroy();(p=this.cieTextures)==null||p.x.destroy(),(m=this.cieTextures)==null||m.y.destroy(),(g=this.cieTextures)==null||g.z.destroy()}};r(M,"MAX_SPECTRAL_RESOLUTION",5e3),r(M,"DEFAULT_BOX_SIZE",30);let D=M;async function ne(l){const e=await fetch(l);if(!e.ok)throw new Error(`Failed to load MSDF image: ${l} (${e.status})`);const t=await e.blob();return createImageBitmap(t)}function se(l,e,t){const{width:i,height:n}=e,s=l.createTexture({label:`MSDF: ${t}`,size:{width:i,height:n,depthOrArrayLayers:1},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT});return l.queue.copyExternalImageToTexture({source:e},{texture:s},{width:i,height:n}),s}class ae{constructor(e,t="/msdf"){r(this,"device");r(this,"msdfs",new Map);r(this,"loadingPromises",new Map);r(this,"basePath");r(this,"metadata",null);r(this,"metadataPromise",null);this.device=e,this.basePath=t}async loadMetadata(){return this.metadata?this.metadata:this.metadataPromise?this.metadataPromise:(this.metadataPromise=(async()=>{const e=`${this.basePath}/metadata.json`,t=await fetch(e);return t.ok?(this.metadata=await t.json(),console.log(`[MaskManager] Loaded metadata: pxRange=${this.metadata.pxRange}`),this.metadata):(console.warn(`[MaskManager] Metadata not found at ${e}, using defaults`),this.metadata={pxRange:4,shapes:[]},this.metadata)})(),this.metadataPromise)}async loadMask(e){const t=this.msdfs.get(e);if(t)return t;const i=this.loadingPromises.get(e);if(i)return i;const n=this.doLoadMask(e);this.loadingPromises.set(e,n);try{return await n}finally{this.loadingPromises.delete(e)}}async doLoadMask(e){const t=await this.loadMetadata(),i=`${this.basePath}/${e}.png`;console.log(`[MaskManager] Loading MSDF: ${i}`);const n=await ne(i),s=se(this.device,n,e);t.shapes.find(o=>o.name===e);const a={name:e,width:n.width,height:n.height,texture:s,pxRange:t.pxRange};return this.msdfs.set(e,a),console.log(`[MaskManager] Loaded MSDF: ${e} (${a.width}x${a.height}, pxRange=${a.pxRange})`),a}async loadMasks(e){return Promise.all(e.map(t=>this.loadMask(t)))}getMask(e){return this.msdfs.get(e)}getAllMasks(){return Array.from(this.msdfs.values())}getMaskIndex(e){const i=this.getAllMasks().findIndex(n=>n.name===e);return i<0?(console.warn(`[MaskManager] MSDF not found: ${e}, using default`),0):i}getPxRange(){var e;return((e=this.metadata)==null?void 0:e.pxRange)??4}destroy(){for(const e of this.msdfs.values())e.texture.destroy();this.msdfs.clear(),this.metadata=null}}class re{constructor(){r(this,"loggingMode","silent");r(this,"windowSize",60);r(this,"logIntervalSeconds",5);r(this,"frames",[]);r(this,"frameNumber",0);r(this,"lastLogTime",0);r(this,"currentFrameStart",0);r(this,"currentPassTimings",[]);r(this,"currentReadbackTime",0);r(this,"currentCacheHit",!1);r(this,"hasF16",!1);r(this,"hasTimestampQuery",!1);r(this,"config",{boxSize:15,plotResolution:5e3,averageRadius:5,colorResolution:16,screenWidth:1280,screenHeight:720});this.lastLogTime=performance.now()}setLoggingMode(e){this.loggingMode=e,console.log(`[Profiler] Logging mode: ${e}`)}setWindowSize(e){this.windowSize=e}setDeviceCapabilities(e,t){this.hasF16=e,this.hasTimestampQuery=t}updateConfig(e){this.config={...this.config,...e}}startFrame(){this.currentFrameStart=performance.now(),this.currentPassTimings=[],this.currentReadbackTime=0,this.currentCacheHit=!1}recordPassTimings(e){this.currentPassTimings=e}recordReadbackTime(e){this.currentReadbackTime=e}recordCacheHit(e){this.currentCacheHit=e}endFrame(){const e=performance.now(),t=e-this.currentFrameStart,i={frameNumber:this.frameNumber++,timestamp:e,frameTime:t,passTimings:this.currentPassTimings,readbackTime:this.currentReadbackTime,cacheHit:this.currentCacheHit};this.frames.push(i),this.frames.length>this.windowSize&&this.frames.shift(),this.loggingMode==="verbose"?this.logFrame(i):this.loggingMode==="summary"&&e-this.lastLogTime>=this.logIntervalSeconds*1e3&&(this.logSummary(),this.lastLogTime=e)}logFrame(e){const t=e.passTimings.map(i=>`${i.name}: ${i.duration.toFixed(2)}ms`).join(", ");console.log(`[Profiler] Frame ${e.frameNumber}: total=${e.frameTime.toFixed(2)}ms, ${t}, readback=${e.readbackTime.toFixed(2)}ms, cache=${e.cacheHit?"HIT":"MISS"}`)}logSummary(){const e=this.getSummary();console.log(`[Profiler] Summary (${this.frames.length} frames): FPS=${e.avgFPS.toFixed(1)}, frame=${e.avgFrameTime.toFixed(2)}ms, P0=${e.avgPass0.toFixed(2)}ms, P1=${e.avgPass1.toFixed(2)}ms, P2=${e.avgPass2.toFixed(2)}ms, P3=${e.avgPass3.toFixed(2)}ms, readback=${e.avgReadback.toFixed(2)}ms, cacheHit=${(e.cacheHitRate*100).toFixed(1)}%`)}getMetrics(){return this.frames.length>0?this.frames[this.frames.length-1]:null}getSummary(){if(this.frames.length===0)return{avgFPS:0,avgFrameTime:0,avgPass0:0,avgPass1:0,avgPass2:0,avgPass3:0,avgReadback:0,cacheHitRate:0,minFrameTime:0,maxFrameTime:0};let e=0,t=0,i=0,n=0,s=0,a=0,o=0,h=1/0,u=0;for(const p of this.frames){e+=p.frameTime,a+=p.readbackTime,p.cacheHit&&o++,p.frameTime<h&&(h=p.frameTime),p.frameTime>u&&(u=p.frameTime);for(const m of p.passTimings)m.name.includes("Pass 0")?t+=m.duration:m.name.includes("Pass 1")?i+=m.duration:m.name.includes("Pass 2")?n+=m.duration:m.name.includes("Pass 3")&&(s+=m.duration)}const c=this.frames.length,d=e/c;return{avgFPS:d>0?1e3/d:0,avgFrameTime:d,avgPass0:t/c,avgPass1:i/c,avgPass2:n/c,avgPass3:s/c,avgReadback:a/c,cacheHitRate:o/c,minFrameTime:h,maxFrameTime:u}}generateWarnings(){const e=[],t=this.getSummary();t.avgFPS<30&&e.push(`Low FPS: ${t.avgFPS.toFixed(1)} (target: 60)`),t.avgFrameTime>33&&e.push(`High frame time: ${t.avgFrameTime.toFixed(2)}ms (target: <16.6ms)`),t.avgPass2>10&&e.push(`Spectrum box computation slow: ${t.avgPass2.toFixed(2)}ms`),t.avgReadback>5&&e.push(`Buffer readback slow: ${t.avgReadback.toFixed(2)}ms`),t.cacheHitRate<.5&&e.push(`Low cache hit rate: ${(t.cacheHitRate*100).toFixed(1)}%`);const i=this.frames.filter(n=>n.frameTime>t.avgFrameTime*2).length;return i>this.windowSize*.1&&e.push(`Frame time spikes: ${i} frames > 2x average`),e}generateReport(){return{timestamp:new Date().toISOString(),config:this.config,summary:this.getSummary(),frames:[...this.frames],warnings:this.generateWarnings(),deviceInfo:{hasF16:this.hasF16,hasTimestampQuery:this.hasTimestampQuery}}}downloadReport(){const e=this.generateReport(),t=JSON.stringify(e,null,2),i=new Blob([t],{type:"application/json"}),n=URL.createObjectURL(i),s=document.createElement("a");s.href=n,s.download=`profiling-report-${Date.now()}.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(n),console.log("[Profiler] Report downloaded")}getDisplayText(){const e=this.getSummary(),t=[],i=e.avgFPS>=55?"green":e.avgFPS>=30?"yellow":"red";return t.push(`FPS: ${e.avgFPS.toFixed(1)} [${i}]`),t.push(`Frame: ${e.avgFrameTime.toFixed(2)}ms (${e.minFrameTime.toFixed(1)}-${e.maxFrameTime.toFixed(1)})`),t.push("---"),t.push(`Pass 0 (Color): ${e.avgPass0.toFixed(2)}ms`),t.push(`Pass 1 (Norm): ${e.avgPass1.toFixed(2)}ms`),t.push(`Pass 2 (Spectrum): ${e.avgPass2.toFixed(2)}ms`),t.push(`Pass 3 (Average): ${e.avgPass3.toFixed(2)}ms`),t.push(`Readback: ${e.avgReadback.toFixed(2)}ms`),t.push("---"),t.push(`Cache: ${(e.cacheHitRate*100).toFixed(0)}% hit`),t.push(`f16: ${this.hasF16?"ON":"OFF"}`),t.push("---"),t.push("[P] Toggle overlay"),t.push("[D] Download report"),t}reset(){this.frames=[],this.frameNumber=0}}const S=new re;class oe{constructor(){r(this,"context",null);r(this,"pipeline",null);r(this,"maskManager",null);r(this,"width",0);r(this,"height",0);r(this,"shapes",[]);r(this,"materials",[]);r(this,"backgroundMode","normal");r(this,"emissionEnabled",!0);r(this,"sampleX",-1);r(this,"sampleY",-1);r(this,"lastSpectrum",new Float32Array(0));r(this,"lastGlobalMax",1);r(this,"cachedSampleX",-1);r(this,"cachedSampleY",-1);r(this,"cachedShapesHash","");r(this,"cachedBackgroundMode","normal");r(this,"cachedEmissionEnabled",!0);r(this,"spectrumCacheValid",!1)}async init(){return this.context=await q(),this.context?(this.pipeline=new D(this.context.device),await this.pipeline.initialize(),S.setDeviceCapabilities(this.context.device.features.has("shader-f16"),this.context.device.features.has("timestamp-query")),!0):!1}resize(e,t){this.width=e,this.height=t}setMaterials(e){this.materials=e,this.pipeline&&this.pipeline.setMaterials(e)}setShapes(e){this.shapes=e}setBackgroundMode(e){this.backgroundMode=e}setEmissionEnabled(e){this.emissionEnabled=e}computeShapesHash(){return this.shapes.map(e=>`${e.x},${e.y},${e.width},${e.height},${e.materialIndex},${e.maskIndex},${e.temperature}`).join("|")}isSpectrumCacheValid(){return!(!this.spectrumCacheValid||this.sampleX!==this.cachedSampleX||this.sampleY!==this.cachedSampleY||this.backgroundMode!==this.cachedBackgroundMode||this.emissionEnabled!==this.cachedEmissionEnabled||this.computeShapesHash()!==this.cachedShapesHash)}updateSpectrumCache(){this.cachedSampleX=this.sampleX,this.cachedSampleY=this.sampleY,this.cachedBackgroundMode=this.backgroundMode,this.cachedEmissionEnabled=this.emissionEnabled,this.cachedShapesHash=this.computeShapesHash(),this.spectrumCacheValid=!0}invalidateSpectrumCache(){this.spectrumCacheValid=!1}async render(){if(!this.pipeline||this.width===0||this.height===0)return new ImageData(1,1);S.startFrame();const e=this.sampleX>=0&&this.sampleY>=0,t=e&&this.isSpectrumCacheValid();S.recordCacheHit(t);const i={width:this.width,height:this.height,wavelengthMin:200,wavelengthMax:1e3,spectralResolution:16,backgroundMode:this.backgroundMode,enableEmission:this.emissionEnabled,sampleX:t?-1:this.sampleX,sampleY:t?-1:this.sampleY,msdfPxRange:this.getMsdfPxRange(),plotResolution:5e3,averageRadius:5,boxSize:15};S.updateConfig({boxSize:i.boxSize,plotResolution:i.plotResolution,averageRadius:i.averageRadius,colorResolution:i.spectralResolution,screenWidth:this.width,screenHeight:this.height});const n=await this.pipeline.compute(i,this.shapes);this.lastGlobalMax=n.globalMaxIntensity,S.recordPassTimings(this.pipeline.getPassTimings());const s=performance.now(),a=await this.pipeline.readRGBOutput();e&&!t&&(this.lastSpectrum=await this.pipeline.readSpectrumOutput(),this.updateSpectrumCache());const o=performance.now();S.recordReadbackTime(o-s);const h=new ImageData(this.width,this.height);for(let u=0;u<this.width*this.height;u++)h.data[u*4+0]=Math.round(a[u*4+0]*255),h.data[u*4+1]=Math.round(a[u*4+1]*255),h.data[u*4+2]=Math.round(a[u*4+2]*255),h.data[u*4+3]=255;return S.endFrame(),h}getGlobalMaxIntensity(){return this.lastGlobalMax}async loadMasks(e){if(!this.context||!this.pipeline){console.warn("[WebGPURenderer] Cannot load MSDF - not initialized");return}this.maskManager||(this.maskManager=new ae(this.context.device,"/msdf")),await this.maskManager.loadMasks(e);const t=this.maskManager.getAllMasks();this.pipeline.setMaskTextures(t.map(i=>i.texture)),console.log(`[WebGPURenderer] Loaded ${e.length} MSDF textures`)}getMaskIndex(e){var t;return((t=this.maskManager)==null?void 0:t.getMaskIndex(e))??0}getMaskDimensions(e){var i;const t=(i=this.maskManager)==null?void 0:i.getMask(e);return t?{width:t.width,height:t.height}:{width:256,height:256}}getMsdfPxRange(){var e;return((e=this.maskManager)==null?void 0:e.getPxRange())??4}setSamplePoint(e,t){this.sampleX=e,this.sampleY=t}async sampleSpectrum(e,t){return this.sampleX=e,this.sampleY=t,this.lastSpectrum}destroy(){var e,t,i;(e=this.pipeline)==null||e.destroy(),(t=this.maskManager)==null||t.destroy(),(i=this.context)==null||i.device.destroy()}}class le{constructor(){r(this,"width",0);r(this,"height",0);r(this,"shapes",[]);r(this,"materials",[]);r(this,"backgroundMode","normal");r(this,"emissionEnabled",!0);r(this,"lastSpectrum",new Float32Array(320).fill(1));r(this,"lastGlobalMax",1)}async init(){return console.log("[CPURenderer] Using CPU fallback"),!0}resize(e,t){this.width=e,this.height=t}setMaterials(e){this.materials=e}setShapes(e){this.shapes=e}setBackgroundMode(e){this.backgroundMode=e}setEmissionEnabled(e){this.emissionEnabled=e}async render(){const e=new ImageData(this.width,this.height),t=this.backgroundMode==="dark"?0:255;for(let i=0;i<this.width*this.height;i++)e.data[i*4+0]=t,e.data[i*4+1]=t,e.data[i*4+2]=t,e.data[i*4+3]=255;return e}async sampleSpectrum(e,t){return this.lastSpectrum}getGlobalMaxIntensity(){return this.lastGlobalMax}async loadMasks(e){console.log("[CPUFallbackRenderer] MSDF loading not supported in CPU mode")}getMaskIndex(e){return 0}getMaskDimensions(e){return{width:256,height:256}}getMsdfPxRange(){return 4}destroy(){}}async function he(){const l=new oe;if(await l.init())return l;console.warn("[createRenderer] WebGPU not available, using CPU fallback");const e=new le;return await e.init(),e}class ue{constructor(e){r(this,"wrapper");r(this,"canvas");r(this,"ctx");r(this,"renderer",null);r(this,"state");r(this,"animationId",null);this.wrapper=document.createElement("div"),this.wrapper.style.cssText=`
      position: relative;
      display: inline-block;
    `,e.appendChild(this.wrapper),this.canvas=document.createElement("canvas"),this.canvas.width=1280,this.canvas.height=720,this.canvas.style.display="block",this.wrapper.appendChild(this.canvas);const t=this.canvas.getContext("2d");if(!t)throw new Error("Failed to get 2D context");this.ctx=t,this.state={width:this.canvas.width,height:this.canvas.height,isInitialized:!1,currentDemo:null}}async initialize(){this.renderer=await he(),this.renderer.resize(this.state.width,this.state.height),this.state.isInitialized=!0,console.log("[GameScene] Initialized"),this.startRenderLoop()}loadDemo(e){this.state.currentDemo&&this.state.currentDemo.cleanup(this),this.state.currentDemo=e,e.initialize(this),console.log(`[GameScene] Loaded demo: ${e.name}`)}getCurrentDemo(){return this.state.currentDemo}getRenderer(){return this.renderer}getDimensions(){return{width:this.state.width,height:this.state.height}}getCanvas(){return this.canvas}getContext(){return this.ctx}resize(e,t){var a;const i=1.7777777777777777;let n=e,s=t;e/t>i?n=Math.floor(t*i):s=Math.floor(e/i),this.canvas.width=n,this.canvas.height=s,this.state.width=n,this.state.height=s,this.renderer&&this.renderer.resize(n,s),(a=this.state.currentDemo)!=null&&a.resize&&this.state.currentDemo.resize(this,n,s)}startRenderLoop(){const e=async()=>{await this.update(),this.animationId=requestAnimationFrame(e)};this.animationId=requestAnimationFrame(e)}async update(){var t;if(!this.state.isInitialized||!this.renderer)return;(t=this.state.currentDemo)!=null&&t.update&&this.state.currentDemo.update(this);const e=await this.renderer.render();this.ctx.putImageData(e,0,0)}destroy(){var e;this.animationId!==null&&cancelAnimationFrame(this.animationId),this.state.currentDemo&&this.state.currentDemo.cleanup(this),(e=this.renderer)==null||e.destroy(),this.wrapper.remove()}}const ce=1280,de=720;class pe{constructor(e,t,i){r(this,"container");r(this,"overlay",null);r(this,"scaleWrapper",null);r(this,"items",[]);r(this,"gameScene");r(this,"demos");r(this,"onSelect",null);r(this,"resizeHandler",null);this.container=e,this.gameScene=t,this.demos=i}show(e){this.overlay||(this.onSelect=e||null,this.createOverlay())}hide(){this.overlay&&(this.resizeHandler&&(window.removeEventListener("resize",this.resizeHandler),this.resizeHandler=null),this.overlay.remove(),this.overlay=null,this.scaleWrapper=null,this.items=[])}toggle(e){this.overlay?this.hide():this.show(e)}createOverlay(){this.overlay=document.createElement("div"),this.overlay.style.cssText=`
      position: absolute;
      top: 0;
      left: 0;
      right: 0;
    ...
    `,this.overlay.appendChild(this.scaleWrapper),this.updateScale(),this.resizeHandler=()=>this.updateScale(),window.addEventListener("resize",this.resizeHandler);const e=document.createElement("h1");e.textContent="Select Demo",e.style.cssText=`
      ...
      margin-bottom: 24px;
    `,this.scaleWrapper.appendChild(e);const t=this.gameScene.getCurrentDemo();for(const n of this.demos){const s=(t==null?void 0:t.name)===n.name,a=this.createButton(n,s);this.scaleWrapper.appendChild(a.element),this.items.push(a)}const i=document.createElement("button");i.textContent="Close (M)",i.style.cssText=`
      margin-top: 24px;
      padding: 8px 16px;
      font-size: 16px;
      background: #666;
    ...
    `,i.onclick=()=>this.hide(),this.scaleWrapper.appendChild(i),this.overlay.onclick=n=>{n.target===this.overlay&&this.hide()},this.container.appendChild(this.overlay)}updateScale(){if(!this.scaleWrapper)return;const{width:e,height:t}=this.gameScene.getDimensions(),i=Math.min(e/ce,t/de);this.scaleWrapper.style.transform=`scale(${i})`}createButton(e,t){const i=document.createElement("button");i.style.cssText=`
      ...
      cursor: pointer;
      text-align: left;
    `;const n=document.createElement("div");if(n.textContent=e.name,n.style.fontWeight="bold",i.appendChild(n),e.description){const s=document.createElement("div");s.textContent=e.description,s.style.cssText="font-size: 14px; color: #ccc; margin-top: 4px;",i.appendChild(s)}return i.onmouseover=()=>{t||(i.style.background="#444")},i.onmouseout=()=>{t||(i.style.background="#333")},i.onclick=()=>{var s;this.gameScene.loadDemo(e),(s=this.onSelect)==null||s.call(this,e),this.hide()},{demo:e,element:i}}}const me=1280;class fe{constructor(){r(this,"name","Empty");r(this,"description","Minimal placeholder demo")}initialize(e){console.log("[EmptyDemo] Initialized"),this.render(e)}resize(e,t,i){this.render(e)}cleanup(e){console.log("[EmptyDemo] Cleaned up")}render(e){const t=e.getContext(),{width:i,height:n}=e.getDimensions(),s=i/me;t.fillStyle="#333",t.fillRect(0,0,i,n),t.fillStyle="#fff",t.font=`${24*s}px sans-serif`,t.textAlign="center",t.fillText("Empty Demo",i/2,n/2-20*s),t.font=`${14*s}px sans-serif`,t.fillText("Press M to open menu",i/2,n/2+20*s)}}const ge=1280;class xe{constructor(){r(this,"name","Interactivity");r(this,"description","Object placement and connection systems");r(this,"objects",[]);r(this,"selectedObject",null);r(this,"baseGridSize",50)}initialize(e){console.log("[InteractivityDemo] Initialized"),this.objects=[{id:"greenSquare",x:5,y:5,width:1,height:1,color:"#22c55e",shape:"square"},{id:"magentaSquare",x:6,y:5,width:1,height:1,color:"#ec4899",shape:"square"},{id:"redCircle",x:7,y:5,width:1,height:1,color:"#ef4444",shape:"circle"},{id:"blueTriangle",x:9,y:5,width:1,height:1,color:"#3b82f6",shape:"triangle"},{id:"yellowRect",x:5,y:8,width:2,height:1,color:"#eab308",shape:"rectangle"},{id:"blackSquare",x:7,y:8,width:2,height:2,color:"#1a1a1a",shape:"square"}];const t=e.getCanvas();t.addEventListener("mousedown",i=>this.onMouseDown(i,e)),t.addEventListener("mousemove",i=>this.onMouseMove(i,e)),t.addEventListener("mouseup",()=>this.onMouseUp(e)),this.render(e)}update(e){this.render(e)}cleanup(e){console.log("[InteractivityDemo] Cleaned up"),this.objects=[],this.selectedObject=null}resize(e,t,i){this.render(e)}getScale(e){const{width:t}=e.getDimensions();return t/ge}getScaledGridSize(e){return this.baseGridSize*this.getScale(e)}onMouseDown(e,t){const i=t.getCanvas(),n=i.getBoundingClientRect(),s=i.width/n.width,a=i.height/n.height,o=(e.clientX-n.left)*s,h=(e.clientY-n.top)*a,u=this.getScaledGridSize(t);for(const c of this.objects){const d=c.x*u,p=c.y*u,m=c.width*u,g=c.height*u;if(o>=d&&o<d+m&&h>=p&&h<p+g){this.selectedObject=c;return}}}onMouseMove(e,t){if(!this.selectedObject)return;const i=t.getCanvas(),n=i.getBoundingClientRect(),s=i.width/n.width,a=i.height/n.height,o=(e.clientX-n.left)*s,h=(e.clientY-n.top)*a,u=this.getScaledGridSize(t);this.selectedObject.x=Math.floor(o/u),this.selectedObject.y=Math.floor(h/u)}onMouseUp(e){this.selectedObject=null}render(e){const t=e.getContext(),{width:i,height:n}=e.getDimensions(),s=this.getScale(e),a=this.getScaledGridSize(e);t.fillStyle="#e5e5e5",t.fillRect(0,0,i,n),t.strokeStyle="#ccc",t.lineWidth=1;for(let c=0;c<=i;c+=a)t.beginPath(),t.moveTo(c,0),t.lineTo(c,n),t.stroke();for(let c=0;c<=n;c+=a)t.beginPath(),t.moveTo(0,c),t.lineTo(i,c),t.stroke();for(const c of this.objects){const d=c.x*a,p=c.y*a,m=c.width*a,g=c.height*a,f=2*s;t.fillStyle=c.color,c.shape==="circle"?(t.beginPath(),t.ellipse(d+m/2,p+g/2,m/2-f,g/2-f,0,0,Math.PI*2),t.fill()):c.shape==="triangle"?(t.beginPath(),t.moveTo(d+m/2,p+f),t.lineTo(d+m-f,p+g-f),t.lineTo(d+f,p+g-f),t.closePath(),t.fill()):t.fillRect(d+f,p+f,m-f*2,g-f*2),c===this.selectedObject&&(t.strokeStyle="#fff",t.lineWidth=3*s,t.strokeRect(d+s,p+s,m-s*2,g-s*2))}const o=300*s,h=30*s,u=14*s;t.fillStyle="rgba(0, 0, 0, 0.7)",t.fillRect(10*s,n-40*s,o,h),t.fillStyle="#fff",t.font=`${u}px sans-serif`,t.textAlign="left",t.fillText("Click and drag objects to move them",20*s,n-20*s)}}function N(l,e,t,i){if(i){const n=t-e,s=4,a=(Math.exp(s*l)-1)/(Math.exp(s)-1);return e+n*a}return e+l*(t-e)}function be(l,e,t,i){if(i){const n=t-e;if(n===0)return 0;const s=(l-e)/n,a=4,o=Math.exp(a)-1;return Math.log(1+s*o)/a}return(l-e)/(t-e)}class ve{constructor(e,t){r(this,"container");r(this,"track");r(this,"handle");r(this,"valueDisplay");r(this,"labelElement",null);r(this,"options");r(this,"value");r(this,"isDragging",!1);if(this.options={min:t.min,max:t.max,value:t.value,logarithmic:t.logarithmic??!1,label:t.label??"",width:t.width??200,onChange:t.onChange??(()=>{})},this.value=this.options.value,this.container=document.createElement("div"),this.container.style.cssText=`
      display: flex;
      flex-direction: column;
      margin: 8px 0;
      user-select: none;
    ...
    `;const i=document.createElement("div");i.textContent=this.options.title,i.style.cssText=`
      ...
      font-weight: bold;
      margin-bottom: 4px;
    `,this.container.appendChild(i),this.canvas=document.createElement("canvas"),this.canvas.width=this.options.width,this.canvas.height=this.options.height,this.canvas.style.display="block";const n=this.canvas.getContext("2d");if(!n)throw new Error("Failed to get canvas context");if(this.ctx=n,this.container.appendChild(this.canvas),this.options.enableZoom){const s=document.createElement("div");s.style.cssText="margin-top: 4px;",this.container.appendChild(s),this.rangeSlider=new ye(s,{min:this.options.wavelengthMin,max:this.options.wavelengthMax,valueMin:this.options.wavelengthMin,valueMax:this.options.wavelengthMax,minRange:8,width:this.options.width-16,label:"Wavelength Range (nm)",formatValue:a=>`${Math.round(a)}`,onChange:(a,o)=>{this.viewMin=a,this.viewMax=o,this.render()}})}e.appendChild(this.container),this.render()}setSpectrum(e){this.spectrum=e,this.render()}setRange(e,t){this.options.wavelengthMin=e,this.options.wavelengthMax=t,this.viewMin=e,this.viewMax=t,this.rangeSlider&&this.rangeSlider.setRange(e,t,!1),this.render()}setViewRange(e,t){this.viewMin=Math.max(this.options.wavelengthMin,e),this.viewMax=Math.min(this.options.wavelengthMax,t),this.rangeSlider&&this.rangeSlider.setRange(this.viewMin,this.viewMax,!1),this.render()}resetZoom(){this.viewMin=this.options.wavelengthMin,this.viewMax=this.options.wavelengthMax,this.rangeSlider&&this.rangeSlider.reset(),this.render()}setLockedPosition(e,t){this.lockedX=e,this.lockedY=t,this.isLocked=e!==null&&t!==null,this.render()}setGlobalMax(e){this.globalMax=e,this.render()}destroy(){var e;(e=this.rangeSlider)==null||e.destroy(),this.container.remove()}render(){const{width:e,height:t,wavelengthMin:i,wavelengthMax:n,showRainbow:s}=this.options,a=this.ctx,o=this.viewMin,h=this.viewMax;if(a.fillStyle="#1a1a1a",a.fillRect(0,0,e,t),s){const p=Math.max(380,o),m=Math.min(700,h);for(let g=0;g<e;g++){const f=o+g/e*(h-o);if(f>=p&&f<=m){const[w,P,x]=Se(f);a.fillStyle=`rgb(${w},${P},${x})`,a.fillRect(g,0,1,20)}}}a.strokeStyle="#666",a.lineWidth=1;const u=t-20;a.beginPath(),a.moveTo(30,u),a.lineTo(e-10,u),a.stroke(),a.beginPath(),a.moveTo(30,25),a.lineTo(30,u),a.stroke(),a.fillStyle="#888",a.font="10px sans-serif",a.textAlign="center";const c=5;for(let d=0;d<=c;d++){const p=30+d/c*(e-40),m=o+d/c*(h-o);a.fillText(`${Math.round(m)}`,p,t-5)}if(a.textAlign="right",a.fillText("1.0",25,30),a.fillText("0.5",25,(25+u)/2),a.fillText("0",25,u),this.spectrum&&this.spectrum.length>0){a.strokeStyle="#4a90e2",a.lineWidth=2,a.beginPath();const p=u-25,m=30,g=e-40,w=(n-i)/(this.spectrum.length-1);let P,x;if(this.globalMax!==null&&this.globalMax>0)P=this.globalMax,x=.9;else{let y=0;for(let v=0;v<this.spectrum.length;v++){const b=i+v*w;b>=o&&b<=h&&(y=Math.max(y,this.spectrum[v]))}P=y||1,x=1}let G=!1;for(let y=0;y<this.spectrum.length;y++){const v=i+y*w;if(v>=o&&v<=h){const b=(v-o)/(h-o),k=m+b*g,B=u-this.spectrum[y]/P*p*x;G?a.lineTo(k,B):(a.moveTo(k,B),G=!0)}}a.stroke()}this.isLocked&&(a.fillStyle="rgba(255, 255, 0, 0.3)",a.beginPath(),a.arc(e-20,35,8,0,Math.PI*2),a.fill(),a.fillStyle="#ff0",a.font="10px sans-serif",a.textAlign="center",a.fillText("🔒",e-20,38))}}class Me{constructor(e,t){r(this,"container");r(this,"contentArea");r(this,"sliders",new Map);r(this,"options");this.options={title:t.title,width:t.width??250,background:t.background??"rgba(0, 0, 0, 0.75)"},this.container=document.createElement("div"),this.container.style.cssText=`
    ...
    `,this.container.appendChild(i),this.contentArea=document.createElement("div"),this.container.appendChild(this.contentArea),e.appendChild(this.container)}addSlider(e,t){const i=new ve(this.contentArea,{...t,width:this.options.width-24});return this.sliders.set(e,i),i}getSlider(e){return this.sliders.get(e)}setSliderValue(e,t,i=!1){const n=this.sliders.get(e);n&&n.setValue(t,i)}addElement(e){this.contentArea.appendChild(e)}setVisible(e){this.container.style.display=e?"block":"none"}destroy(){for(const e of this.sliders.values())e.destroy();this.sliders.clear(),this.container.remove()}}const Pe=299792458,Te=1380649e-29,ke=16605390666e-37,Be=Math.log(2);function Ce(l,e,t){if(e<=0||t<=0)return 0;const i=l*1e-9,n=t*ke;return 2*i/Pe*Math.sqrt(2*Te*e*Be/n)*1e9}function Ee(l,e){return l<=0||e<=0?0:e*l}function Ge(l,e,t,i,n){const s=l.naturalWidth,a=Ce(l.wavelength,e,t),o=Ee(i,n);return Math.sqrt(s*s+a*a+o*o)}function Re(l,e,t){if(l<=0||e<=0||t<=0)return 1;const i=l*e*t;return Math.pow(10,-i)}const Ie=.5;function ze(l,e,t,i){let n=Ie;for(const s of e.peaks){const o=Ge(s,t,e.mass,i,e.pressureBroadening)/2.35482,h=l-s.wavelength;n+=s.extinction*Math.exp(-.5*Math.pow(h/o,2))}return n}function O(l,e,t,i,n){return{id:l,name:e,molecules:t,bandGap:i,uvCutoff:n,generateTransmissionSpectrum(s,a,o,h){const u=new Float32Array(o),c=(a-s)/(o-1);for(let d=0;d<o;d++){const p=s+d*c;let m=1;if(p<n){const g=Math.max(0,(p-100)/(n-100));m*=g*g}for(const g of t){const f=h.concentrations[g.id]||0;if(f>0){const w=ze(p,g,h.temperature,h.pressure);m*=Re(w,f,h.pathLength)}}u[d]=Math.max(0,Math.min(1,m))}return u}}}function E(l,e=.01,t=1,i=300,n=.001){const s={};for(const a of l.molecules)s[a.id]=e;return{concentrations:s,pathLength:t,temperature:i,pressure:n}}const Ue={id:"copper-sulfate",name:"Copper Sulfate",mass:159.6,pressureBroadening:0,peaks:[{wavelength:800,extinction:8,naturalWidth:100}]},De={id:"methylene-blue",name:"Methylene Blue",mass:319.9,pressureBroadening:0,peaks:[{wavelength:665,extinction:50,naturalWidth:50},{wavelength:605,extinction:20,naturalWidth:40}]};function Le(){return O("water","Water",[Ue,De],7.5,200)}const Fe={id:"chromium-ion",name:"Chromium Ion (Cr³⁺)",mass:52,pressureBroadening:0,peaks:[{wavelength:550,extinction:25,naturalWidth:80},{wavelength:400,extinction:18,naturalWidth:60}]},Oe={id:"potassium-permanganate",name:"Potassium Permanganate",mass:158,pressureBroadening:0,peaks:[{wavelength:525,extinction:30,naturalWidth:40},{wavelength:545,extinction:30,naturalWidth:40}]};function $e(){return O("crystal","Crystal",[Fe,Oe],9,150)}const Ae={id:"sodium",name:"Sodium (Na)",mass:22.99,pressureBroadening:.02,peaks:[{wavelength:589,extinction:40,naturalWidth:.1},{wavelength:589.6,extinction:40,naturalWidth:.1}]},We={id:"neon",name:"Neon (Ne)",mass:20.18,pressureBroadening:.015,peaks:[{wavelength:585.2,extinction:15,naturalWidth:.1},{wavelength:640.2,extinction:25,naturalWidth:.1},{wavelength:703.2,extinction:10,naturalWidth:.1}]},Ne={id:"mercury",name:"Mercury (Hg)",mass:200.59,pressureBroadening:.025,peaks:[{wavelength:253.7,extinction:60,naturalWidth:.1},{wavelength:365,extinction:35,naturalWidth:.1},{wavelength:435.8,extinction:25,naturalWidth:.1},{wavelength:546.1,extinction:45,naturalWidth:.1},{wavelength:579,extinction:35,naturalWidth:.1}]};function _e(){return O("gas","Gas",[Ae,We,Ne],10,100)}const U=1280,R=720;class _{constructor(){r(this,"name","Spectral Coloring");r(this,"description","Physics-based spectral absorption and transmission");r(this,"enableEmission",!1);r(this,"enableDarkMode",!1);r(this,"shapes",[]);r(this,"backgroundMode","normal");r(this,"uvMode",!1);r(this,"controlPanels",[]);r(this,"spectralGraph",null);r(this,"uvButton",null);r(this,"darkButton",null);r(this,"uiContainer",null);r(this,"uiScaleWrapper",null);r(this,"measurementIndicator",null);r(this,"profilingOverlay",null);r(this,"profilingVisible",!1);r(this,"masksLoaded",!1);r(this,"renderInProgress",!1);r(this,"needsRender",!0);r(this,"mouseX",-1);r(this,"mouseY",-1);r(this,"lockedX",-1);r(this,"lockedY",-1);r(this,"isSpectrumLocked",!1);r(this,"mouseMoveHandler",null);r(this,"keyHandler",null)}initialize(e){console.log(`[${this.name}] Initialized`);const t=Le(),i=$e(),n=_e(),s={id:"tint",name:"Background Tint",molecules:[],bandGap:0,uvCutoff:0,generateTransmissionSpectrum:(o,h,u)=>new Float32Array(u).fill(.66)};this.shapes=[{id:"bg-grid",name:"Background Grid",maskName:"circle-grid",x:0,y:0,width:1280,height:720,layer:0,material:s,properties:E(s)},{id:"square",name:"Square (Water)",maskName:"rectangle",x:20,y:80,width:200,height:200,layer:1,material:t,properties:E(t)},{id:"circle",name:"Circle (Crystal)",maskName:"circle",x:150,y:80,width:200,height:200,layer:1,material:i,properties:E(i)},{id:"triangle",name:"Triangle (Gas)",maskName:"triangle",x:280,y:80,width:200,height:200,layer:1,material:n,properties:E(n)}],this.createUI(e);const a=e.getCanvas();this.mouseMoveHandler=o=>{const h=a.getBoundingClientRect(),u=a.width/h.width,c=a.height/h.height;this.mouseX=Math.floor((o.clientX-h.left)*u),this.mouseY=Math.floor((o.clientY-h.top)*c)},a.addEventListener("mousemove",this.mouseMoveHandler),this.keyHandler=o=>{var h,u,c;o.key==="r"||o.key==="R"?(h=this.reset)==null||h.call(this,e):o.key==="l"||o.key==="L"?this.isSpectrumLocked?(this.isSpectrumLocked=!1,this.lockedX=-1,this.lockedY=-1,(u=this.spectralGraph)==null||u.setLockedPosition(null,null)):this.mouseX>=0&&this.mouseY>=0&&(this.isSpectrumLocked=!0,this.lockedX=this.mouseX,this.lockedY=this.mouseY,(c=this.spectralGraph)==null||c.setLockedPosition(this.lockedX,this.lockedY)):o.key==="p"||o.key==="P"?(this.profilingVisible=!this.profilingVisible,this.profilingOverlay&&(this.profilingOverlay.style.display=this.profilingVisible?"block":"none"),S.setLoggingMode(this.profilingVisible?"summary":"silent")):(o.key==="d"||o.key==="D")&&this.profilingVisible&&S.downloadReport()},document.addEventListener("keydown",this.keyHandler),this.updateRenderer(e)}update(e){this.needsRender&&!this.renderInProgress&&(this.renderInProgress=!0,this.updateRenderer(e).finally(()=>{this.renderInProgress=!1}),this.needsRender=!1),this.updateSpectrumGraph(e),this.profilingVisible&&this.profilingOverlay&&this.updateProfilingOverlay()}reset(e){var i,n,s,a;for(const o of this.shapes){const h=E(o.material);o.properties=h}let t=0;for(const o of this.shapes){if(o.layer===0)continue;const h=this.controlPanels[t];if(h){for(const u of o.material.molecules)h.setSliderValue(u.id,o.properties.concentrations[u.id]||.01);h.setSliderValue("depth",o.properties.pathLength),this.enableEmission&&h.setSliderValue("temperature",o.properties.temperature),o.material.id==="gas"&&h.setSliderValue("pressure",o.properties.pressure),t++}}this.backgroundMode="normal",this.uvMode=!1,(i=this.uvButton)==null||i.setEnabled(!1,!1),(n=this.darkButton)==null||n.setEnabled(!1,!1),this.isSpectrumLocked=!1,this.lockedX=-1,this.lockedY=-1,(s=this.spectralGraph)==null||s.setLockedPosition(null,null),(a=this.spectralGraph)==null||a.resetZoom(),this.needsRender=!0,console.log(`[${this.name}] Reset to initial state`)}async updateSpectrumGraph(e){if(!this.spectralGraph)return;const t=e.getRenderer();if(!t)return;this.spectralGraph.setGlobalMax(1);const i=this.isSpectrumLocked?this.lockedX:this.mouseX,n=this.isSpectrumLocked?this.lockedY:this.mouseY;if(this.updateMeasurementIndicator(e,i,n),i>=0&&n>=0){const{width:s,height:a}=e.getDimensions();if(i<s&&n<a){const o=await t.sampleSpectrum(i,n);o.length>0&&this.spectralGraph.setSpectrum(o)}}}updateMeasurementIndicator(e,t,i){if(!this.measurementIndicator)return;const{width:n,height:s}=e.getDimensions();if(t<0||i<0||t>=n||i>=s){this.measurementIndicator.style.display="none";return}this.measurementIndicator.style.display="block";const a=U/n,o=R/s,h=t*a,u=i*o;this.measurementIndicator.style.left=`${h}px`,this.measurementIndicator.style.top=`${u}px`,this.isSpectrumLocked?(this.measurementIndicator.style.borderColor="rgba(100, 200, 255, 0.9)",this.measurementIndicator.style.background="rgba(100, 200, 255, 0.3)",this.measurementIndicator.style.borderWidth="2px",this.measurementIndicator.style.boxShadow="0 0 8px rgba(100, 200, 255, 0.5)"):(this.measurementIndicator.style.borderColor="rgba(255, 255, 255, 0.8)",this.measurementIndicator.style.background="rgba(255, 255, 255, 0.2)",this.measurementIndicator.style.borderWidth="2px",this.measurementIndicator.style.boxShadow="0 0 4px rgba(0, 0, 0, 0.5)")}updateProfilingOverlay(){if(!this.profilingOverlay)return;const e=S.getDisplayText();let t="";for(const i of e){const n=i.match(/^(.+) \[(green|yellow|red)\]$/);n?t+=`<div style="color: ${{green:"#4f4",yellow:"#ff4",red:"#f44"}[n[2]]||"#fff"}">${n[1]}</div>`:i==="---"?t+='<hr style="border: none; border-top: 1px solid rgba(255,255,255,0.2); margin: 4px 0;">':t+=`<div>${i}</div>`}this.profilingOverlay.innerHTML=t}cleanup(e){var i,n,s,a,o,h,u;console.log(`[${this.name}] Cleaned up`);const t=e.getCanvas();this.mouseMoveHandler&&(t.removeEventListener("mousemove",this.mouseMoveHandler),this.mouseMoveHandler=null),this.keyHandler&&(document.removeEventListener("keydown",this.keyHandler),this.keyHandler=null);for(const c of this.controlPanels)c.destroy();this.controlPanels=[],(i=this.spectralGraph)==null||i.destroy(),this.spectralGraph=null,(n=this.uvButton)==null||n.destroy(),(s=this.darkButton)==null||s.destroy(),this.uvButton=null,this.darkButton=null,(a=this.measurementIndicator)==null||a.remove(),this.measurementIndicator=null,(o=this.profilingOverlay)==null||o.remove(),this.profilingOverlay=null,(h=this.uiScaleWrapper)==null||h.remove(),this.uiScaleWrapper=null,(u=this.uiContainer)==null||u.remove(),this.uiContainer=null,this.shapes=[]}createUI(e){const t=e.getCanvas(),i=t.parentElement;this.uiContainer=document.createElement("div"),this.uiContainer.style.cssText=`
      position: absolute;
      top: 0;
      left: 0;
      width: ${t.width}px;
    ...
    `,i.style.position="relative",i.appendChild(this.uiContainer),this.uiScaleWrapper=document.createElement("div"),this.uiScaleWrapper.style.cssText=`
      ...
      pointer-events: none;
    `,this.uiContainer.appendChild(this.uiScaleWrapper),this.updateUIScale(e);const n=R-250;let s=0;for(let h=0;h<this.shapes.length;h++){const u=this.shapes[h];if(u.layer>0){const c=this.createControlPanel(e,u,10+s*270,n);this.controlPanels.push(c),s++}}const a=document.createElement("div");a.style.cssText=`
      position: absolute;
      top: 10px;
      right: 10px;
      pointer-events: auto;
    `,this.uiScaleWrapper.appendChild(a),this.uvButton=new L(a,{enabled:!1,labelOn:"UV Mode: ON",labelOff:"UV Mode: OFF",onToggle:h=>{this.uvMode=h,this.backgroundMode=h?"uv":"normal",this.needsRender=!0}}),this.enableDarkMode&&(this.darkButton=new L(a,{enabled:!1,labelOn:"Dark Mode: ON",labelOff:"Dark Mode: OFF",onToggle:h=>{this.backgroundMode=h?"dark":this.uvMode?"uv":"normal",this.needsRender=!0}}));const o=document.createElement("div");o.style.cssText=`
      position: absolute;
      top: 60px;
      right: 10px;
      pointer-events: auto;
    ...
    `,this.uiScaleWrapper.appendChild(this.profilingOverlay)}updateUIScale(e){if(!this.uiContainer||!this.uiScaleWrapper)return;const{width:t,height:i}=e.getDimensions(),n=Math.min(t/U,i/R);this.uiContainer.style.width=`${t}px`,this.uiContainer.style.height=`${i}px`,this.uiScaleWrapper.style.transform=`scale(${n})`}resize(e,t,i){this.updateUIScale(e),this.needsRender=!0}createControlPanel(e,t,i,n){const s=document.createElement("div");s.style.cssText=`
      position: absolute;
      left: ${i}px;
      top: ${n}px;
      pointer-events: auto;
    `,this.uiScaleWrapper.appendChild(s);const a=new Me(s,{title:t.name,width:250});a.addSlider("depth",{min:0,max:1e3,value:t.properties.pathLength,logarithmic:!0,label:"Depth (cm)",onChange:o=>{t.properties.pathLength=o,this.needsRender=!0}});for(const o of t.material.molecules)a.addSlider(o.id,{min:0,max:1,value:t.properties.concentrations[o.id]||.01,logarithmic:!0,label:o.name,onChange:h=>{t.properties.concentrations[o.id]=h,this.needsRender=!0}});return this.enableEmission&&a.addSlider("temperature",{min:0,max:13e3,value:t.properties.temperature,logarithmic:!0,label:"Temperature (K)",onChange:o=>{t.properties.temperature=o,this.needsRender=!0}}),t.material.id==="gas"&&a.addSlider("pressure",{min:0,max:50,value:t.properties.pressure,logarithmic:!0,label:"Pressure (atm)",onChange:o=>{t.properties.pressure=o,this.needsRender=!0}}),a}async updateRenderer(e){const t=e.getRenderer();if(!t)return;if(!this.masksLoaded){const s=[...new Set(this.shapes.map(a=>a.maskName))];await t.loadMasks(s),this.masksLoaded=!0}const i=[];for(const s of this.shapes){const a=s.material.generateTransmissionSpectrum(200,1e3,5e3,s.properties);i.push(a)}t.setMaterials(i);const n=this.shapes.map((s,a)=>{const o=t.getMaskIndex(s.maskName),h=t.getMaskDimensions(s.maskName);return console.log(`[SpectralDemo] Shape ${s.id}: maskName=${s.maskName} -> maskIndex=${o}, texSize=${h.width}x${h.height}`),{x:s.x,y:s.y,width:s.width,height:s.height,temperature:this.enableEmission?s.properties.temperature:300,layer:s.layer,materialIndex:a,maskIndex:o,texWidth:h.width,texHeight:h.height}});t.setShapes(n),t.setBackgroundMode(this.backgroundMode),t.setEmissionEnabled(this.enableEmission)}}class X extends _{constructor(){super(...arguments);r(this,"name","Advanced Spectral Coloring");r(this,"description","Physics-based spectral absorption, emission, and scattering");r(this,"enableEmission",!0);r(this,"enableDarkMode",!0)}}const Xe=1280,He=720;class Ye{constructor(){r(this,"name","GPU Demo");r(this,"description","GPU rendering pipeline diagnostics");r(this,"mode","pattern");r(this,"uiContainer",null);r(this,"uiScaleWrapper",null);r(this,"modeButtons",[])}initialize(e){console.log("[GPUDemo] Initialized"),this.createUI(e),this.render(e)}update(e){this.render(e)}cleanup(e){var t,i;console.log("[GPUDemo] Cleaned up");for(const n of this.modeButtons)n.destroy();this.modeButtons=[],(t=this.uiScaleWrapper)==null||t.remove(),this.uiScaleWrapper=null,(i=this.uiContainer)==null||i.remove(),this.uiContainer=null}resize(e,t,i){this.updateUIScale(e)}updateUIScale(e){if(!this.uiContainer||!this.uiScaleWrapper)return;const{width:t,height:i}=e.getDimensions(),n=Math.min(t/Xe,i/He);this.uiContainer.style.width=`${t}px`,this.uiContainer.style.height=`${i}px`,this.uiScaleWrapper.style.transform=`scale(${n})`}createUI(e){const t=e.getCanvas(),i=t.parentElement;this.uiContainer=document.createElement("div"),this.uiContainer.style.cssText=`
      position: absolute;
      top: 0;
      left: 0;
      width: ${t.width}px;
    ...
    `,i.style.position="relative",i.appendChild(this.uiContainer),this.uiScaleWrapper=document.createElement("div"),this.uiScaleWrapper.style.cssText=`
      ...
      transform-origin: top left;
      pointer-events: auto;
    `,this.uiContainer.appendChild(this.uiScaleWrapper),this.updateUIScale(e);const n=["pattern","gradient","spectrum","shapes"];for(const s of n){const a=new L(this.uiScaleWrapper,{enabled:s===this.mode,labelOn:s.charAt(0).toUpperCase()+s.slice(1),labelOff:s.charAt(0).toUpperCase()+s.slice(1),onToggle:()=>{this.mode=s;for(const o of this.modeButtons)o.setEnabled(o===a,!1)}});this.modeButtons.push(a)}}render(e){const t=e.getContext(),{width:i,height:n}=e.getDimensions();switch(this.mode){case"pattern":this.renderPattern(t,i,n);break;case"gradient":this.renderGradient(t,i,n);break;case"spectrum":this.renderSpectrum(t,i,n);break;case"shapes":this.renderShapes(t,i,n);break}t.fillStyle="rgba(0, 0, 0, 0.7)",t.fillRect(10,n-40,200,30),t.fillStyle="#fff",t.font="14px sans-serif",t.textAlign="left",t.fillText(`Mode: ${this.mode}`,20,n-20)}renderPattern(e,t,i){for(let s=0;s<t;s+=50)for(let a=0;a<i;a+=50){const o=(s/50+a/50)%2===0;e.fillStyle=o?"#fff":"#000",e.fillRect(s,a,50,50)}}renderGradient(e,t,i){for(let n=0;n<t;n++){const s=n/t*360;e.fillStyle=`hsl(${s}, 100%, 50%)`,e.fillRect(n,0,1,i)}}renderSpectrum(e,t,i){for(let n=0;n<t;n++){const s=380+n/t*320,[a,o,h]=this.wavelengthToRGB(s);e.fillStyle=`rgb(${a},${o},${h})`,e.fillRect(n,0,1,i)}}renderShapes(e,t,i){e.fillStyle="#e5e5e5",e.fillRect(0,0,t,i),e.fillStyle="rgba(0, 100, 200, 0.7)",e.fillRect(100,200,200,200),e.fillStyle="rgba(200, 0, 100, 0.7)",e.beginPath(),e.arc(500,300,100,0,Math.PI*2),e.fill(),e.fillStyle="rgba(200, 200, 0, 0.7)",e.beginPath(),e.moveTo(800,200),e.lineTo(900,400),e.lineTo(700,400),e.closePath(),e.fill()}wavelengthToRGB(e){let t=0,i=0,n=0;return e>=380&&e<440?(t=-(e-440)/60,i=0,n=1):e>=440&&e<490?(t=0,i=(e-440)/50,n=1):e>=490&&e<510?(t=0,i=1,n=-(e-510)/20):e>=510&&e<580?(t=(e-510)/70,i=1,n=0):e>=580&&e<645?(t=1,i=-(e-645)/65,n=0):e>=645&&e<=700&&(t=1,i=0,n=0),[Math.round(t*255),Math.round(i*255),Math.round(n*255)]}}function Ve(){return[new fe,new xe,new _,new X,new Ye]}function qe(){return new X}async function je(){console.log("[P4] Initializing...");const l=document.getElementById("game-container");if(!l){console.error("[P4] Game container not found");return}const e=new ue(l);await e.initialize();const t=()=>{const a=l.clientWidth,o=l.clientHeight;e.resize(a,o)};t(),window.addEventListener("resize",t);const i=Ve(),n=new pe(l,e,i),s=qe();e.loadDemo(s),document.addEventListener("keydown",a=>{(a.key==="m"||a.key==="M")&&n.toggle()}),console.log("[P4] Ready - Press M to open menu")}je().catch(console.error);
//# sourceMappingURL=index-BK3oPyjb.js.map
